...
2. Start the service
   1. Open a new terminal session in [pizza-party/solution/](../../pizza-party/solution) and run `mvn clean compile quarkus:dev`
...
4. Clean up
   1. Run `docker compose down` in a terminal session under [pizza-party/](../../pizza-party)
